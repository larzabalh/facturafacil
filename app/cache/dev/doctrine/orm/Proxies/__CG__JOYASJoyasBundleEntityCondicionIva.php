 ...
 */
class CondicionIva extends \JOYAS\JoyasBundle\Entity\CondicionIva implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'descripcion', 'estado', 'clientes', 'usuarios');
    }
