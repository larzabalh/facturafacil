...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'session.manager' => 'getSession_ManagerService',
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'C:/Users/hernanl/facturafacil/app/cache/dev/annotations', true);
    }
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'C:/Users/hernanl/facturafacil/app/Resources');
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b->setNamespace('sf2orm_default_411a2929ff1c868b1aff68b988a8d742');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_411a2929ff1c868b1aff68b988a8d742');

        $d = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => 'C:\\Users\\hernanl\\facturafacil\\src\\JOYAS\\JoyasBundle\\Entity')), 'JOYAS\\JoyasBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('JOYASJoyasBundle' => 'JOYAS\\JoyasBundle\\Entity'));
        $e->setMetadataCacheImpl($a);
        $e->setQueryCacheImpl($b);
        $e->setResultCacheImpl($c);
        $e->setMetadataDriverImpl($d);
        $e->setProxyDir('C:/Users/hernanl/facturafacil/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'C:/Users/hernanl/facturafacil/app/Resources');
    }
    ...
    protected function getJmsDiExtra_Metadata_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('C:/Users/hernanl/facturafacil/app/cache/dev/jms_diextra/metadata'));
    ...
    {
        return $this->services['knp.snappy.pdf'] = new \Knp\Snappy\Pdf('C:/Users/hernanl/facturafacil/app/wkhtmltopdf', array('lowquality' => false, 'enable-javascript' => true, 'debug-javascript' => true));
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('C:/Users/hernanl/facturafacil/app/logs/dev.log', 100, true);
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return CHOMP\SGIBundle\Services\Mailer\Mailer A CHOMP\SGIBundle\Services\Mailer\Mailer instance.
     */
    protected function getMyMailerService()
    {
        return $this->services['my_mailer'] = new \CHOMP\SGIBundle\Services\Mailer\Mailer('noSeQueEsEstoNiDondeSeUsa');
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:C:/Users/hernanl/facturafacil/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, 'C:/Users/hernanl/facturafacil/app/cache/dev/assetic/routing.yml', array('cache_dir' => 'C:/Users/hernanl/facturafacil/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('C:/Users/hernanl/facturafacil/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('C:/Users/hernanl/facturafacil/app');
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('C:/Users/hernanl/facturafacil/app/cache/dev/sessions');
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return JOYAS\JoyasBundle\Services\SessionManager A JOYAS\JoyasBundle\Services\SessionManager instance.
     */
    protected function getSession_ManagerService()
    {
        return $this->services['session.manager'] = new \JOYAS\JoyasBundle\Services\SessionManager($this);
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('C:/Users/hernanl/facturafacil/app/cache/dev/sessions');
    }
    ...
    protected function getSiphoc_Pdf_CssToHtmlService()
    {
        ...
        $instance->setBasePath('C:/Users/hernanl/facturafacil/app/../httpdocs');
    ...
    protected function getSwiftmailer_Mailer_Default_TransportService()
    {
        ...
        $a->setUsername('info@nttonline.byethost33.com');
        $a->setPassword('Ntt2016');
        $a->setAuthMode('login');
        ...
        $instance->setHost('sv87.ifastnet.com');
        $instance->setPort(290);
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'C:/Users/hernanl/facturafacil/app', 'UTF-8');
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, 'C:/Users/hernanl/facturafacil/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('C:\\Users\\hernanl\\facturafacil\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('C:\\Users\\hernanl\\facturafacil\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/views', 'Security');
        $instance->addPath('C:\\Users\\hernanl\\facturafacil\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/views', 'Twig');
        $instance->addPath('C:\\Users\\hernanl\\facturafacil\\vendor\\symfony\\swiftmailer-bundle\\Symfony\\Bundle\\SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('C:\\Users\\hernanl\\facturafacil\\vendor\\doctrine\\doctrine-bundle\\Doctrine\\Bundle\\DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('C:\\Users\\hernanl\\facturafacil\\src\\JOYAS\\JoyasBundle/Resources/views', 'JOYASJoyas');
        $instance->addPath('C:\\Users\\hernanl\\facturafacil\\src\\Acme\\DemoBundle/Resources/views', 'AcmeDemo');
        $instance->addPath('C:\\Users\\hernanl\\facturafacil\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('C:\\Users\\hernanl\\facturafacil\\vendor\\sensio\\distribution-bundle\\Sensio\\Bundle\\DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('C:/Users/hernanl/facturafacil/app/Resources/views');
        $instance->addPath('C:\\Users\\hernanl\\facturafacil\\vendor\\symfony\\symfony\\src\\Symfony\\Bridge\\Twig/Resources/views/Form');
        $instance->addPath('C:\\Users\\hernanl\\facturafacil\\vendor\\knplabs\\knp-menu\\src\\Knp\\Menu/Resources/views');
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'C:/Users/hernanl/facturafacil/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('C:/Users/hernanl/facturafacil/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'C:/Users/hernanl/facturafacil/app/cache/dev');
    }
    ...
    {
        return array(
            'kernel.root_dir' => 'C:/Users/hernanl/facturafacil/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'C:/Users/hernanl/facturafacil/app/cache/dev',
            'kernel.logs_dir' => 'C:/Users/hernanl/facturafacil/app/logs',
            'kernel.bundles' => array(
                ...
                'JOYASJoyasBundle' => 'JOYAS\\JoyasBundle\\JOYASJoyasBundle',
            ...
            'debug.container.dump' => 'C:/Users/hernanl/facturafacil/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => 'C:/Users/hernanl/facturafacil/app/cache/dev/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => 'C:\\Users\\hernanl\\facturafacil\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml',
            ),
            ...
            'profiler.storage.dsn' => 'file:C:/Users/hernanl/facturafacil/app/cache/dev/profiler',
            ...
            'router.resource' => 'C:/Users/hernanl/facturafacil/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:/Users/hernanl/facturafacil/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.mailer.default.transport.smtp.port' => 290,
            'swiftmailer.mailer.default.transport.smtp.host' => 'sv87.ifastnet.com',
            'swiftmailer.mailer.default.transport.smtp.username' => 'info@nttonline.byethost33.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'Ntt2016',
            ...
            'assetic.cache_dir' => 'C:/Users/hernanl/facturafacil/app/cache/dev/assetic',
            ...
            'assetic.read_from' => 'C:/Users/hernanl/facturafacil/app/../web',
            'assetic.write_to' => 'C:/Users/hernanl/facturafacil/app/../web',
            ...
            'doctrine.orm.proxy_dir' => 'C:/Users/hernanl/facturafacil/app/cache/dev/doctrine/orm/Proxies',
            ...
            'jms_di_extra.cache_dir' => 'C:/Users/hernanl/facturafacil/app/cache/dev/jms_diextra',
            ...
            'siphoc_pdf.basepath' => 'C:/Users/hernanl/facturafacil/app/../httpdocs',
            'siphoc_pdf.options' => array(
                'lowquality' => false,
                'enable-javascript' => true,
                'debug-javascript' => true,
            ),
            'siphoc_pdf.binary' => 'C:/Users/hernanl/facturafacil/app/wkhtmltopdf',
